...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) throws MessagingException {
    ...
    return AuthenticationResponse.builder()
            ...
            .id(user.getIdEmployee()) // Assuming user.getId() returns Long
            .email(user.getEmail())
...
*/
  ...
  private void revokeAllUserTokens(Employee user) {
    var validUserTokens = tokenRepository.findAllValidTokenByUser(user.getIdEmployee());
  ...
  public void activateAccount(String token) throws MessagingException {
    ...
    var user = repository.findById(savedToken.getEmployee().getIdEmployee())
            .orElseThrow(() -> new UsernameNotFoundException("User not found"));
  ...
  private String generateAndSaveActivationToken(Employee user) {
    // Generate a token
  ...
  private void sendValidationEmail(Employee user) throws MessagingException {
  ...
  Employee  sendChangePasswEmail(Employee user) throws MessagingException {
